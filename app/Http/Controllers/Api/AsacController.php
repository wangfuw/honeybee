...
class AsacController extends BaseController
{
    public function __construct()
    {
        $this->middleware('auth:api', ['except' => ['excharge','withdraw','coin_info',
            'asac_login','search','info','index','blocks','owners','get_notices','get_destory','get_flue','block_info'
        ]]);
    }
    ...
    public function get_flue(Request $request)
    {
        ...
        $list = $handler->select('id','from_address','to_address','num','trade_hash','block_id','created_at','type')->orderBy('id','desc')->forPage($page,$page_size)->get()
