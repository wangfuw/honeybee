...
class CreateConfigTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('config', function (Blueprint $table) {
            ...
            $table->decimal('lucky_base',2,1)->default(4)->comment('幸运专区初级奖励');
            $table->decimal('lucky_middle',2,1)->default(4.5)->comment('幸运专区中级奖励');
            $table->decimal('lucky_last',2,1)->default(6 )->comment('幸运专区初级奖励');
            ...
            $table->decimal('ticket_ratio_rmb',1,1)->default(1)->comment('消费卷比人名币');
            ...
            $table->decimal('free_green_ratio_lucky',1,1)->default(1)->comment('释放绿色积分消耗幸运值比');
